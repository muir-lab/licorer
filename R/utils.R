...
acceptable_units <- function() {
  ...
  c("CustomBLC" = ("mol m-2 s-1"), "Oxygen" = ("%"), "S" = ("cm2"),
    ...
    "Pa" = ("kPa"), ".deltaPcham" = ("kPa"), "Tair" = ("\u00b0C"), "Offset" = ("\u00b0C"),
    ...
    "Q_farred" = ("\u00b5mol m-2 s-1"), "TSPF" = ("s"), ".deltaCO2:MN" = ("\u00b5mol mol-1"),
    ".deltaCO2:SLP" = ("\u00b5mol min-1 mol-1"), ".deltaCO2:SD" = ("\u00b5mol mol-1"), "F:SLP" = ("min-1"),
    ".deltaH2O:MN" = ("mmol mol-1"), ".deltaH2O:SLP" = ("mmol min-1 mol-1"), ".deltaH2O:SD" = ("mmol mol-1"),
    ...
    "F_dc_avg" = ("1"), "count" = ("1"), ".deltaCO2:OK" = ("1"), "Stable" = ("1"), "Total" = ("1"),
    "f_farred" = ("1"), "F:MN" = ("1"), "F:SD" = ("1"), "F:OK" = ("1"), ".deltaH2O:OK" = ("1"),
    ...
    "P3_.deltaF" = ("1"), "Custom" = ("mol m-2 s-1"), "H2O_a" = ("mmol mol-1"),
